...
import com.example.assignment2.Main2Activity;
...
//                        StringBuffer buffer = new StringBuffer();
                        ...
                        while (res.moveToNext()){
                            ...
                            arrayList.add("Length: " + res.getString(1) + "\n");
                            arrayList.add("Size: " + res.getString(2) + "\n");
                            arrayList.add("Singer: " + res.getString(3) + "\n");
                            arrayList.add("Link: " + res.getString(4) + "\n\n");
                        }
